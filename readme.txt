...
Tags: Simple Share, share articles, share pages, share count, share website, share url, facebook share, twitter share, pinterest share
...
Please visit the following link for live example:
1. http://blogspalace.com/
2. http://compressorspalace.com/
...
== Screenshots ==
1. Admin settings screen to configure sssp.
2. Shows the share links at the bottom of the article!


== Changelog ==

= 0.0.5 =
* Fix condition to add share button with Single Page content

= 0.0.4 =
* Added option to show share buttons with post excerpt

= 0.0.3 =
* Enable config option to choose post type to show share buttons
* Shortcode [msbd-sssp] added
