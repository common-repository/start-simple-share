...
class MsbdSSSAdmin {
    ...
    function init_admin_menu() {
       ...
       add_menu_page(
            ...
            MSBD_SSSP_URL.'images/msbd_favicon_16.png',
            '11.13'
        );
    }
        ...
        <form id="msbd-sssp-settings-form" action="" method="post">
            ...
            <div class="form-table">
                ...
                <div class="form-row">
                    ...
                    <div class="grid_8">
                        <?php
                        echo draw_post_types_select_box( 'name="sssp_post_types[]" id="sssp_post_types" multiple=""', msbd_extract_array($options, 'sssp_post_types'));
                        ?>
                        <p class="note">Share buttons will execute only for the selected post types!</p>
                    </div>
                </div>
                    
                <div class="form-row">
                    <div class="grid_4">
                        <label for="sssp_show_with_post_excerpt">Show with Post Excerpt</label>
                    </div>
                    
                    <div class="grid_8">
                        <?php
                        echo $this->draw_yes_no_select_box( 'name="sssp_show_with_post_excerpt" id="sssp_show_with_post_excerpt"', msbd_extract_array($options, 'sssp_show_with_post_excerpt'));
                        ?>
                        <p class="note">Select "Yes" to bind share buttons with post excerpt!</p>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="grid_8">
                        <?php
                        echo draw_position_select_box( 'name="sssp_position" id="sssp_position"', msbd_extract_array($options, 'sssp_position'));
                        ?>
                    </div>
                </div>
