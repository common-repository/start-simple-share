...
class MsbdSSSOptions {
    ...
    public function __construct($core) {
        ...
        $this->defaults = array(
            ...
            'sssp_show_with_post_excerpt' => 'no',
            'sssp_position' => 'after',
    ...
    public function update_options() {            
        ...
        if (isset($_POST['action']) && $_POST['action'] === 'msbd-sssp-update-options') {
            ...
            if (!isset($_POST['sssp_selected_buttons'])) { 
                ...
                $_POST['sssp_selected_buttons'] = msbd_sanitization($_POST['sssp_selected_buttons'], "text");
            }
            
            if (!isset($_POST['sssp_title'])) { 
                $_POST['sssp_title'] = NULL; 
            } else {
                $_POST['sssp_title'] = msbd_sanitization($_POST['sssp_title'], "text");
            }
            
            /*if (!isset($_POST['sssp_post_types'])) {
                $_POST['sssp_post_types'] = NULL;
            } else {
                $_POST['sssp_post_types'] = $_POST['sssp_post_types'];
            }*/
            
            if (!isset($_POST['sssp_show_share_count'])) { 
                $_POST['sssp_show_share_count'] = null;
            } else {
                $_POST['sssp_show_share_count'] = msbd_sanitization($_POST['sssp_show_share_count'], "boolean");
            }
            
            if ( !isset($_POST['sssp_show_with_post_excerpt']) ) { 
                $_POST['sssp_show_with_post_excerpt'] = null;
            } else {
                $_POST['sssp_show_with_post_excerpt'] = msbd_sanitization($_POST['sssp_show_with_post_excerpt'], "boolean");
            }
